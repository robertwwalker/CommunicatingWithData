...
[I have a template for `distill` that I created in a few minutes.](https://robertwwalker.github.io/Distill/)  The first key thing is to make sure distill is installed with `install.packages("distill")`.  I would point you to the RStudio examples.  [RStudio](https://rstudio.github.io/distill/website.html) and [update](https://posit.co/blog/distill/).  Also, [Thomas Mock has a really nice example on the MockUp](https://themockup.blog/posts/2020-08-01-building-a-blog-with-distill/).
